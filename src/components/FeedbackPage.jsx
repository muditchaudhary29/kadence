  ...
  return (
    <div className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="brutal-card px-5 py-3 rounded-2xl bg-amber-400 text-slate-900 flex items-center gap-3 shrink-0">
          ...
          <div>
            ...
            <div className="text-[10px] font-extrabold uppercase mt-0.5 opacity-90">{feedbacks.length} User Review{feedbacks.length !== 1 ? 's' : ''}</div>
          </div>
        </div>
      </div>
